(function ($) {
	...
	/* Work Step Item List Active Start */
	var $work_step_item_list = $('.work-step-item-list');
	if ($work_step_item_list.length) {
		var $work_step_item = $work_step_item_list.find('.work-step-item');
	...
	/* Work Step Item List Active End */
